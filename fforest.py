...
# train_loader, valid_loader, test_loader = forest_loader(batch_size=128, c0=c0, c1=c1, adv=adv, adv_valid=False)
# train_loader, valid_loader, test_loader = adv_forest_loader(batch_size=128, split=51, head='advLogReg2AdamIgnRandInit_best')
train_loader, valid_loader, test_loader = adv_forest_loader(batch_size=128, split=51, adv_valid=True, c0=c0, c1=c1, head='advLogReg2AdamIgnRandInit_best')
