...
tr_loader, val_loader, te_loader = adv_forest_loader(batch_size=128, adv_valid=True, c0=c0, c1=c1, head='advLogReg2AdamRandInitShare3_best')
# model = FLN(train_feat=[51, 51], nc=2, h1=4, classes=7)
# model = FLR(train_feat=[51, 51], nc=2, classes=7)
model = FLRSH(feats=[c0, c1], nc=2, classes=7)
...
cmab = fcmab(model, loss, opt, nc=2, n=100, c='mabLin', head='forest_FLRSH_Adv_Sh3', verbose=True)
