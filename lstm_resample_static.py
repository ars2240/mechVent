...
model_prefix = "LSTM_norsampl_stat_"
...
# from this point the script is the same as lstm.py except for minor modifications in the lstm architecture to use the static predictors
