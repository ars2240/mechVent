...
for sh in [1, 85, 171, 255, 341]:
    ...
    if sh == 1:
        c = [[141, 56, 227, 44, 59, 57, 320, 167, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 294, 297, 31, 74,
             ...
             [279, 54, 253, 18, 237, 288, 301, 68, 190, 15, 223, 249, 91, 221, 193, 16, 274, 23, 208, 239, 295, 321,
        ...
        c = [[130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 294, 297, 31, 74, 116, 4, 85, 212, 217, 233, 269, 270,
              ...
              *range(352, 358), 45, 46],
             [190, 15, 223, 249, 91, 221, 193, 16, 274, 23, 208, 239, 295, 321, 329, 334, *range(340, 345), 70, 102,
    ...
    cmab = fcmab(model, loss, opt, nc=2, n=100, c='mabLin', head=head + '_FLNSH10c_Decay.01_RandPert', verbose=True)
